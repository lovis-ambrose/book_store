...
public class BookController {
    ...
    public ResponseEntity<?> uploadBookCoverImage(@PathVariable("book-id") Integer bookId, @Parameter() @RequestPart("file") MultipartFile file, Authentication connectedUser) {
